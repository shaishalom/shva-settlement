...
/**
 * The persistent class for the atm_transaction_record database table.
 * 
 */
public class AtmTransactionRecordOldEntity implements Serializable {
	...
	public AtmTransactionRecordOldEntity() {
	}
