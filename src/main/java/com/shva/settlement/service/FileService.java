...
import com.shva.settlement.dto.CountDTO;
import com.shva.settlement.dto.FileExportDetailsDTO;
import com.shva.settlement.dto.InputFileDTO;
import com.shva.settlement.dto.InputLineDTO;
import com.shva.settlement.predicate.LegalFilePredicate;
...
public class FileService {
	...
	public Boolean writeToFile(FileExportDetailsDTO fileExportDetailsDTO, List<AtmTransactionRecordDTO> transactionRecoAtmTransactionRecordDTOs) {

		
		
		String fileNameCreated = fileExportDetailsDTO.generateFileName();
		
		Path path = Paths.get(fileExportDetailsDTO.getFolderName() + "/" + fileNameCreated);
